# @berufungirnpm/voluptatibus-optio-aperiam

`@berufungirnpm/voluptatibus-optio-aperiam` is a cache for asynchronous fetching of resources
with full deduplication, i.e. the same resource is only asked once at any given time.

## Install

```bash
npm i @berufungirnpm/voluptatibus-optio-aperiam
```

## Example

```js
import { createCache } from '@berufungirnpm/voluptatibus-optio-aperiam'
...
```js
import { createCache, createStorage } from '@berufungirnpm/voluptatibus-optio-aperiam'
...
```ts
import { createCache, Cache } from "@berufungirnpm/voluptatibus-optio-aperiam";
...
```html
<script src="https://unpkg.com/@berufungirnpm/voluptatibus-optio-aperiam"></script>
